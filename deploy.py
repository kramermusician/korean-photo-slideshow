...
<body>
    ...
    <script>
        ...
        function qRenderPrompt() {{
            const w = qWord();
            if (!w) return;
            document.getElementById('q-heading').textContent = LANG[lang].heading;
            document.getElementById('q-find').textContent = LANG[lang].find;
        ...
        function qClick(e) {{
            ...
            if (qIdx >= qChallenges.length - 1) {{
                ...
                nxt.textContent = LANG[lang].next;
